...
```shell
pacman -S man-db chromium bash-completion steam discord lxterminal pipewire wireplumber pipewire-pulse pipewire-alsa pavucontrol openssh thunar ttf-iosevkaterm-nerd papirus-icon-theme gtk-theme-elementary qt5ct rofi emptty linux-headers i3 nvidia-open nvidia-open-dkms lib32-nvidia-utils htop git xorg sudo base-devel smbclient bluez bluez-utils
```
